...
def test_basic_ranking() -> None:
    ...
    ranked = orchestrator.rank_resource([
        LocalResourceProvider("123", Flavor("123", FlavorType.K8SLICE, FlavorCharacteristics("1", "arm64", "10", "10Gi"), {}, "provider1", {}, {"operational": [100, 120, 130, 150, 120, 110, 100, 90, 130, 150, 100, 80, 180, 40, 80, 130], "embodied": 1300})),
        LocalResourceProvider("122", Flavor("122", FlavorType.K8SLICE, FlavorCharacteristics("1", "arm64", "10", "10Gi"), {}, "provider2", {}, {"operational": [90, 110, 120, 140, 110, 100, 90, 80, 120, 140, 90, 70, 170, 30, 70, 120], "embodied": 1200})),
