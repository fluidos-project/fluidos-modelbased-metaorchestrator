...
class Orchestrator(OrchestratorInterface):
    ...
    def __init__(self, model_name: str = "fluidos/candidate-generation", device: str = "cpu", feedback_db_path: Path = Path("tests/model/feedback/feedback.csv").expanduser()) -> None:
